...
# options/rgbe_isp/benchmark/rgbe_isp_0603_els_isp_v5-test-e10

python tools/22-Color-Events-Eval-in-Each-Video/color_events_isp_eval_in_each_video.py \
  --yaml_file="options/rgbe_isp/benchmark/rgbe_isp_0603_els_isp_v5.yaml" \
  --log_dir="./log/rgbe_isp/benchmark/rgbe_isp_0603_els_isp_v5-test-e10/" \
  --alsologtostderr=True \
  --alsologtostderr=True \
  --RESUME_PATH="./log/rgbe_isp/benchmark/rgbe_isp_0603_els_isp_v5/checkpoint-010.pth.tar" \
  --TEST_ONLY=True \
  --TEST_TAG="els_isp_v5" \
  --VISUALIZE=True
