...
python tools/22-Color-Events-Eval-in-Each-Video/color_events_isp_eval_in_each_video.py \
  --yaml_file="options/rgbe_isp/benchmark/rgbe_isp_0529_pynet_v1.yaml" \
  --log_dir="./log/rgbe_isp/benchmark/rgbe_isp_0529_pynet_v1-test-epoch10/" \
  --alsologtostderr=True \
  --RESUME_PATH="./log/rgbe_isp/benchmark/rgbe_isp_0529_pynet_v1/checkpoint-010.pth.tar" \
  --TEST_ONLY=True \
  --TEST_TAG="pynet_v1" \
  --VISUALIZE=True
