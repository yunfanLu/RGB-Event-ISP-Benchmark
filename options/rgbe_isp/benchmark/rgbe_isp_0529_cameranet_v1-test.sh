...
python tools/22-Color-Events-Eval-in-Each-Video/color_events_isp_eval_in_each_video.py \
  ...
  --log_dir="./log/rgbe_isp/benchmark/rgbe_isp_0529_cameranet_v1-test-epoch05/" \
  --alsologtostderr=True \
  --RESUME_PATH="/hpc2hdd/home/zrao538/proj/color_isp/no_git_yunfan_repo/log/rgbe_isp/benchmark/rgbe_isp_0529_cameranet_v1/checkpoint-005.pth.tar" \
  --TEST_ONLY=True \
  --TEST_TAG="cameranet_v1" \
  --VISUALIZE=True
